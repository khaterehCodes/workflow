...
import { removeUser } from '../../../../core/redux/feature/SociétéUser'
function SociétéUser({ items }) {
    const dispatch = useDispatch();
    return (
        <div className='w-[1200px] h-auto'>
            {items.length === 0 ? (<div className='text-center text-gray-500 py-10'>Aucune société trouvée.</div>)
                : (<>
                    {items.map((item) => (
