...
import { users as initialUsers } from "../../../../core/array/Array";
                ...
                {users.map((user, index) => (
                  <tr key={user.email} className="border-b hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4">
                      <P className={`font-medium px-3 py-1 rounded-full text-sm inline-block ${statusStyles[user.statut] || "text-gray-500 bg-gray-100"}`}>
                        {user.statut}
                      </P>
                    </td>
                    <td className="px-6 py-4">
